  ...
  <div class="container">
    ...
    <?php
      if( have_rows('featured_events_repeater') ):
        while ( have_rows('featured_events_repeater') ) : the_row();
          ?>
          <div class="latest_event mt-5 pb-2">
            <div class="row">
              <div class="col-md-8">
                <div class="featured_card d-sm-flex">
                  <div class="img_container pr-3">
                    <img src="<?php the_sub_field('event_image'); ?>" class="img-fluid" />
                  </div>
              ...
              <div class="col-md-4">
                <div class="details_card mt-5 mt-md-0 p-4">
                  ...
                  <div class="detailed_info mt-4 mb-2">
                    <div class="wwo mb-1">
                      When: <?php echo date('jS F | g:i a', strtotime(get_sub_field('when'))); ?>
                    </div>
                    <div class="wwo mb-1">
                      Where: <?php the_sub_field('where'); ?>
                    </div>
                    <div class="wwo mb-1">
                      Occurs: <?php the_sub_field('occurs'); ?>
                    </div>
                  </div>
                </div>
              </div>
